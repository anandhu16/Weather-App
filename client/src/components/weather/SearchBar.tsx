...
export default function SearchBar({ onLocationSelect, isLoading = false }: SearchBarProps) {
  ...
  return (
    <div className="relative w-full max-w-md">
      ...
      {/* No Results */}
      {showResults && citySearch.data && citySearch.data.length === 0 && !citySearch.isPending && (
        <Card className="absolute top-full left-0 right-0 mt-2 z-50 shadow-lg">
